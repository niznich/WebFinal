        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    ...
                    <img src="{{ asset('/images/education.png')}}" alt="" style="width:64px;">
                    </a>
                </div>
               ...
               @if (Auth::user()->hasRole('student'))
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard.contactteach')" :active="request()->routeIs('dashboard.contactteach')">
                        {{ __('Contact a Teacher Here!') }}
                    </x-nav-link>
                </div>
